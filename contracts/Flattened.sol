...
contract EIP712Base {
    ...
    function getDomainSeparator(address contractAddress)
        private
        view
        returns (bytes32)
    {
        return
            keccak256(
                abi.encode(
                    ...
                    keccak256(
                        bytes(registeredContracts[contractAddress].version)
                    ),
                    getChainID(),
                    contractAddress
                )
...
// File pablock-smart-contracts/contracts/PablockToken.sol@v0.1.0
...
// File pablock-smart-contracts/contracts/EIP712MetaTransaction.sol@v0.1.0
...
// File pablock-smart-contracts/contracts/PablockMetaTxReceiver.sol@v0.1.0
...
// File contracts/ReasonedArtData.sol
...
// File @openzeppelin/contracts/token/ERC721/extensions/ERC721URIStorage.sol@v4.4.0
...
// File contracts/ReasonedArt.sol
